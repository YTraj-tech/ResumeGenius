...
// const Herosection = () => {
//   return (
//     <div className="h-[600px] sm:pl-12 md:pl-16   lg:pt-[80px]  rounded-bl-[100px] md:rounded-bl-[200px] "
//       style={{ background: "linear-gradient(to right, #1e40af, #2563eb, #60a5fa)" }}
//     >
//       <div className=" pt-12 sm:px-6 lg:px-8  md:flex-row justify-center items-center gap-8 md:gap-12">
//         {/* Text Content */}
//         <div className="w-full   lg:flex lg:flex-col lg:justify-center text-center  max-w-2xl   ">
//           <div className="space-y-6 lg:mt-[50px] md:space-y-8">
//             {/* Main Heading */}
//             <h1 className={`${Rak.className} mx-16  sm:mx-9 sm:mt-9 md:pl-[90px]  font-bold text-white leading-[1.1] tracking-tight`}>
...
//             {/* Subtitle */}
//             <p className="text-blue-100 mx-16 sm:mx-12  text-lg sm:text-xl md:text-xl lg:text-2xl leading-relaxed font-light max-w-xl  md:mx-0">
//               Your landing page, always modern, responsive, and beautifully designed.
//             </p>
//             {/* CTA Buttons */}
//             <div className="pt-2 md:pt-6 lg:mt-[-30px] w-full flex justify-center md:justify-start">
...
//         {/* Image Section */}
//         <div className="mb-12 mt-5 sm:mt-5 pl-3  flex w-full md:mb-9 lg:mb-16 lg:ml-[150px] lg:w-1/2 lg:mt-[100px] order-2 md:order-2">
//           {/* Profile Image */}
//           <div className="relative mt-5 ml-2 left-10 top-4  z-10 h-[300px] w-[300px]  rounded-lg shadow-blue-400 shadow-lg sm:left-6 sm:top-6 sm:-ml-6 sm:h-[330px] sm:w-[300px] md:left-8 md:top-8 md:-ml-8 md:h-[320px] md:w-[320px] lg:left-12 lg:top-12 lg:ml-0 lg:h-[500px] lg:w-[500px] xl:h-[500px] xl:w-[600px] border-2 border-blue-50">
//             <Image
//               src="/vasu.jpg"
//               width={600}
//               height={800}
...
//           {/* Resume Image */}
//           <div className="relative pr-2 h-[300px] w-[300px]  rounded-lg shadow-blue-400 shadow-lg sm:h-[330px] sm:w-[300px] md:h-[320px] md:w-[320px] lg:h-[500px] lg:w-[500px] xl:h-[500px] xl:w-[600px]">
//             <Image
//               src="/resume.avif"
//               width={600}
//               height={600}
