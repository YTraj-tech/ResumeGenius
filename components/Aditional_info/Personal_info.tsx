...
// // components/PersonalInfoForm.tsx - Updated version
// 'use client';
...
//     } catch (error) {
//       console.error('Failed to fetch personal info:', error);
//       setMessage({ type: 'error', text: 'Network error: Failed to fetch data' });
//     } finally {
//       setLoading(false);
//     }
//   };
...
//     } catch (error: any) {
//       console.error('Appwrite upload error:', error);
//       throw new Error(error.message || 'Failed to upload image. Please check your connection.');
//     } finally {
//       setUploading(false);
//     }
//   };
...
//       setMessage({ 
//         type: 'error', 
//         text: 'Network error: Failed to save personal information. Please check your connection.' 
//       });
//     } finally {
//       setLoading(false);
//     }
