    ...
    <div className=" h-fit lg:ml-[-300px] bg-gray-100 ">
      ...
      <div className="lg:hidden p-5  ">
          ...
          <button
            ...
            className="bg-blue-700 lg:hidden no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
