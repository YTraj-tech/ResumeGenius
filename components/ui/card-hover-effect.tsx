            ...
            {items.map((item, idx) => (
                ...
                >
                    <AnimatePresence>
                        {hoveredIndex === idx && (
                            <motion.span
                                className="absolute inset-0 h-full  opacity-80 w-full bg-[#EEF2FF] dark:bg-slate-800/[0.8] block rounded-3xl"
...
// Keep the Card, CardTitle, and CardDescription components the same
...
export const CardDescription = ({
    ...
    return (
        <p
            className={cn(
                "mt-8 text-black text-sm tracking-wide leading-relaxed",
                className
            )}
        >
            {children}
