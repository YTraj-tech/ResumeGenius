...
function FlipButton({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className={cn(
        'relative inline-block h-full px-12 py-2 text-sm font-medium cursor-pointer perspective-[1000px] focus:outline-none',
        className,
      )}
      {...props}
    >
